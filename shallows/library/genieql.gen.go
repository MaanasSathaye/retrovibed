...
const MetadataInsertWithDefaultsStaticColumns = `$1,$2,$3,DEFAULT,$4,$5,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11,DEFAULT`
...
func MetadataInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Metadata) MetadataScannerStaticRow {
	const query = `INSERT INTO "library_metadata" ("archive_id","auto_description","bytes","created_at","description","disk_offset","disk_usage","encryption_seed","hidden_at","id","image","known_media_id","mimetype","tombstoned_at","torrent_id","updated_at") VALUES ($1,$2,$3,DEFAULT,$4,$5,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "archive_id","auto_description","bytes","created_at","description","disk_offset","disk_usage","encryption_seed","hidden_at","id","image","known_media_id","mimetype","tombstoned_at","torrent_id","updated_at"`
	var (
		c0  sql.NullString   // archive_id
		c1  sql.NullString   // auto_description
		c2  sql.Null[uint64] // bytes
	...
	c9.String = a.Mimetype
	c10.Valid = true
	c10.String = a.TorrentID // torrent_id
