...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullBool, c1 sql.NullString, c2 ducktype.NullUint64, c3 sql.NullString, c4 sql.NullString, c5 sql.NullString, c6 sql.NullTime, c7 []byte, c8 sql.NullString, c9 sql.NullString, c10 sql.NullInt32, c11 sql.NullBool, c12 sql.NullBool, c13 sql.NullTime, c14 sql.NullString, c15 ducktype.NullUint64, c16 sql.NullTime, err error) {
		c0.Valid = true
		...
		c12.Bool = p.Seeding
		c13.Valid = true
		c13.Time = p.TombstonedAt
		c14.Valid = true
		c14.String = p.Tracker
		c15.Valid = true
		c15.V = p.Uploaded
		c16.Valid = true
		c16.Time = p.VerifyAt
	...
	case 1:
		...
		var (
			...
			r0c15 ducktype.NullUint64
			r0c16 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, err = transform(p[0]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16)), p[1:], true
	case 2:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, err = transform(p[1]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16)), p[2:], true
	case 3:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, err = transform(p[2]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16)), p[3:], true
	case 4:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51),($52,$53,$54,DEFAULT,$55,DEFAULT,$56,DEFAULT,$57,$58,$59,DEFAULT,$60,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,$66,DEFAULT,$67,$68) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16, err = transform(p[3]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16)), p[4:], true
	case 5:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51),($52,$53,$54,DEFAULT,$55,DEFAULT,$56,DEFAULT,$57,$58,$59,DEFAULT,$60,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,$66,DEFAULT,$67,$68),($69,$70,$71,DEFAULT,$72,DEFAULT,$73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,DEFAULT,DEFAULT,$79,$80,$81,$82,$83,DEFAULT,$84,$85) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r4c16, err = transform(p[4]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r4c16)), p[5:], true
	case 6:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51),($52,$53,$54,DEFAULT,$55,DEFAULT,$56,DEFAULT,$57,$58,$59,DEFAULT,$60,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,$66,DEFAULT,$67,$68),($69,$70,$71,DEFAULT,$72,DEFAULT,$73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,DEFAULT,DEFAULT,$79,$80,$81,$82,$83,DEFAULT,$84,$85),($86,$87,$88,DEFAULT,$89,DEFAULT,$90,DEFAULT,$91,$92,$93,DEFAULT,$94,$95,DEFAULT,DEFAULT,$96,$97,$98,$99,$100,DEFAULT,$101,$102) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r5c16, err = transform(p[5]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r4c16, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r5c16)), p[6:], true
	case 7:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51),($52,$53,$54,DEFAULT,$55,DEFAULT,$56,DEFAULT,$57,$58,$59,DEFAULT,$60,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,$66,DEFAULT,$67,$68),($69,$70,$71,DEFAULT,$72,DEFAULT,$73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,DEFAULT,DEFAULT,$79,$80,$81,$82,$83,DEFAULT,$84,$85),($86,$87,$88,DEFAULT,$89,DEFAULT,$90,DEFAULT,$91,$92,$93,DEFAULT,$94,$95,DEFAULT,DEFAULT,$96,$97,$98,$99,$100,DEFAULT,$101,$102),($103,$104,$105,DEFAULT,$106,DEFAULT,$107,DEFAULT,$108,$109,$110,DEFAULT,$111,$112,DEFAULT,DEFAULT,$113,$114,$115,$116,$117,DEFAULT,$118,$119) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r6c16, err = transform(p[6]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r4c16, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r5c16, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r6c16)), p[7:], true
	case 8:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51),($52,$53,$54,DEFAULT,$55,DEFAULT,$56,DEFAULT,$57,$58,$59,DEFAULT,$60,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,$66,DEFAULT,$67,$68),($69,$70,$71,DEFAULT,$72,DEFAULT,$73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,DEFAULT,DEFAULT,$79,$80,$81,$82,$83,DEFAULT,$84,$85),($86,$87,$88,DEFAULT,$89,DEFAULT,$90,DEFAULT,$91,$92,$93,DEFAULT,$94,$95,DEFAULT,DEFAULT,$96,$97,$98,$99,$100,DEFAULT,$101,$102),($103,$104,$105,DEFAULT,$106,DEFAULT,$107,DEFAULT,$108,$109,$110,DEFAULT,$111,$112,DEFAULT,DEFAULT,$113,$114,$115,$116,$117,DEFAULT,$118,$119),($120,$121,$122,DEFAULT,$123,DEFAULT,$124,DEFAULT,$125,$126,$127,DEFAULT,$128,$129,DEFAULT,DEFAULT,$130,$131,$132,$133,$134,DEFAULT,$135,$136) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15, r7c16, err = transform(p[7]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r4c16, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r5c16, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r6c16, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15, r7c16)), p[8:], true
	case 9:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51),($52,$53,$54,DEFAULT,$55,DEFAULT,$56,DEFAULT,$57,$58,$59,DEFAULT,$60,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,$66,DEFAULT,$67,$68),($69,$70,$71,DEFAULT,$72,DEFAULT,$73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,DEFAULT,DEFAULT,$79,$80,$81,$82,$83,DEFAULT,$84,$85),($86,$87,$88,DEFAULT,$89,DEFAULT,$90,DEFAULT,$91,$92,$93,DEFAULT,$94,$95,DEFAULT,DEFAULT,$96,$97,$98,$99,$100,DEFAULT,$101,$102),($103,$104,$105,DEFAULT,$106,DEFAULT,$107,DEFAULT,$108,$109,$110,DEFAULT,$111,$112,DEFAULT,DEFAULT,$113,$114,$115,$116,$117,DEFAULT,$118,$119),($120,$121,$122,DEFAULT,$123,DEFAULT,$124,DEFAULT,$125,$126,$127,DEFAULT,$128,$129,DEFAULT,DEFAULT,$130,$131,$132,$133,$134,DEFAULT,$135,$136),($137,$138,$139,DEFAULT,$140,DEFAULT,$141,DEFAULT,$142,$143,$144,DEFAULT,$145,$146,DEFAULT,DEFAULT,$147,$148,$149,$150,$151,DEFAULT,$152,$153) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, r8c13, r8c14, r8c15, r8c16, err = transform(p[8]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r4c16, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r5c16, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r6c16, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15, r7c16, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, r8c13, r8c14, r8c15, r8c16)), p[9:], true
	default:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,$17),($18,$19,$20,DEFAULT,$21,DEFAULT,$22,DEFAULT,$23,$24,$25,DEFAULT,$26,$27,DEFAULT,DEFAULT,$28,$29,$30,$31,$32,DEFAULT,$33,$34),($35,$36,$37,DEFAULT,$38,DEFAULT,$39,DEFAULT,$40,$41,$42,DEFAULT,$43,$44,DEFAULT,DEFAULT,$45,$46,$47,$48,$49,DEFAULT,$50,$51),($52,$53,$54,DEFAULT,$55,DEFAULT,$56,DEFAULT,$57,$58,$59,DEFAULT,$60,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,$66,DEFAULT,$67,$68),($69,$70,$71,DEFAULT,$72,DEFAULT,$73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,DEFAULT,DEFAULT,$79,$80,$81,$82,$83,DEFAULT,$84,$85),($86,$87,$88,DEFAULT,$89,DEFAULT,$90,DEFAULT,$91,$92,$93,DEFAULT,$94,$95,DEFAULT,DEFAULT,$96,$97,$98,$99,$100,DEFAULT,$101,$102),($103,$104,$105,DEFAULT,$106,DEFAULT,$107,DEFAULT,$108,$109,$110,DEFAULT,$111,$112,DEFAULT,DEFAULT,$113,$114,$115,$116,$117,DEFAULT,$118,$119),($120,$121,$122,DEFAULT,$123,DEFAULT,$124,DEFAULT,$125,$126,$127,DEFAULT,$128,$129,DEFAULT,DEFAULT,$130,$131,$132,$133,$134,DEFAULT,$135,$136),($137,$138,$139,DEFAULT,$140,DEFAULT,$141,DEFAULT,$142,$143,$144,DEFAULT,$145,$146,DEFAULT,DEFAULT,$147,$148,$149,$150,$151,DEFAULT,$152,$153),($154,$155,$156,DEFAULT,$157,DEFAULT,$158,DEFAULT,$159,$160,$161,DEFAULT,$162,$163,DEFAULT,DEFAULT,$164,$165,$166,$167,$168,DEFAULT,$169,$170) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8, r9c9, r9c10, r9c11, r9c12, r9c13, r9c14, r9c15, r9c16, err = transform(p[9]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r0c16, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r1c16, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r2c16, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r3c16, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r4c16, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r5c16, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r6c16, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15, r7c16, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, r8c13, r8c14, r8c15, r8c16, r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8, r9c9, r9c10, r9c11, r9c12, r9c13, r9c14, r9c15, r9c16)), []Metadata(nil), false
	}
}

// MetadataInsertWithDefaultsStaticColumns generated by genieql
const MetadataInsertWithDefaultsStaticColumns = `$1,$2,$3,DEFAULT,$4,$5,$6,DEFAULT,$7,DEFAULT,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,DEFAULT`
...
func MetadataInsertWithDefaultsExplode(a *Metadata) ([]interface{}, error) {
	var (
		...
		c13 sql.NullTime        // tombstoned_at
		c14 sql.NullString      // tracker
		c15 ducktype.NullUint64 // uploaded
	)
	...
	c13.Valid = true
	c13.Time = a.TombstonedAt

	c14.Valid = true
	c14.String = a.Tracker
...
func MetadataInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Metadata) MetadataScannerStaticRow {
	const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,$5,$6,DEFAULT,$7,DEFAULT,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,$15,DEFAULT,$16,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, tracker = EXCLUDED.tracker RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tombstoned_at","tracker","updated_at","uploaded","verify_at"`
	var (
		c0  sql.NullBool        // archivable
		c1  sql.NullString      // auto_description
		c2  ducktype.NullUint64 // bytes
	...
	c14.String = a.Tracker
	c15.Valid = true
	c15.V = a.Uploaded // uploaded
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15))
}
