...
const MetadataScannerStaticColumns = `torrents_metadata."archivable",torrents_metadata."auto_description",torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."encryption_seed",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."imported_at",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."known_media_id",torrents_metadata."mimetype",torrents_metadata."next_announce_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."private",torrents_metadata."seeding",torrents_metadata."tracker",torrents_metadata."updated_at",torrents_metadata."uploaded",torrents_metadata."verify_at"`
...
func (t metadataScannerStatic) Scan(i *Metadata) error {
	...
	if err := t.Rows.Scan(&c0, &c1, &c2, &c3, &c4, &c5, &c6, &c7, &c8, &c9, &c10, &c11, &c12, &c13, &c14, &c15, &c16, &c17, &c18, &c19, &c20, &c21, &c22); err != nil {
		return err
	}
...
func (t MetadataScannerStaticRow) Scan(i *Metadata) error {
	...
	if err := t.row.Scan(&c0, &c1, &c2, &c3, &c4, &c5, &c6, &c7, &c8, &c9, &c10, &c11, &c12, &c13, &c14, &c15, &c16, &c17, &c18, &c19, &c20, &c21, &c22); err != nil {
		return err
	}
...
func MetadataFindByID(ctx context.Context, q sqlx.Queryer, id string) MetadataScannerStaticRow {
	const query = `SELECT torrents_metadata."archivable",torrents_metadata."auto_description",torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."encryption_seed",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."imported_at",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."known_media_id",torrents_metadata."mimetype",torrents_metadata."next_announce_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."private",torrents_metadata."seeding",torrents_metadata."tracker",torrents_metadata."updated_at",torrents_metadata."uploaded",torrents_metadata."verify_at" FROM torrents_metadata WHERE "id" = $1`
...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullBool, c1 sql.NullString, c2 ducktype.NullUint64, c3 sql.NullString, c4 sql.NullString, c5 sql.NullString, c6 sql.NullTime, c7 []byte, c8 sql.NullString, c9 sql.NullString, c10 sql.NullInt32, c11 sql.NullBool, c12 sql.NullBool, c13 sql.NullString, c14 ducktype.NullUint64, c15 sql.NullTime, err error) {
		c0.Valid = true
		...
		c5.String = p.ID
		c6.Valid = true
		c6.Time = p.ImportedAt
		c7 = p.Infohash
		c8.Valid = true
		c8.String = p.KnownMediaID
		c9.Valid = true
		c9.String = p.Mimetype
		c10.Valid = true
		c10.Int32 = int32(p.Peers)
		c11.Valid = true
		c11.Bool = p.Private
		c12.Valid = true
		c12.Bool = p.Seeding
		c13.Valid = true
		c13.String = p.Tracker
		c14.Valid = true
		c14.V = p.Uploaded
		c15.Valid = true
		c15.Time = p.VerifyAt
		return c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, nil
	}
	switch len(p) {
	case 0:
		return nil, []Metadata(nil), false
	case 1:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			...
			r0c14 ducktype.NullUint64
			r0c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15)), p[1:], true
	case 2:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
		...
		if r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, err = transform(p[1]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15)), p[2:], true
	case 3:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r2c11 sql.NullBool
			r2c12 sql.NullBool
			r2c13 sql.NullString
			r2c14 ducktype.NullUint64
			r2c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, err = transform(p[2]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15)), p[3:], true
	case 4:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48),($49,$50,$51,DEFAULT,$52,DEFAULT,$53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,DEFAULT,DEFAULT,$59,$60,$61,$62,DEFAULT,$63,$64) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r3c11 sql.NullBool
			r3c12 sql.NullBool
			r3c13 sql.NullString
			r3c14 ducktype.NullUint64
			r3c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, err = transform(p[3]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15)), p[4:], true
	case 5:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48),($49,$50,$51,DEFAULT,$52,DEFAULT,$53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,DEFAULT,DEFAULT,$59,$60,$61,$62,DEFAULT,$63,$64),($65,$66,$67,DEFAULT,$68,DEFAULT,$69,DEFAULT,$70,$71,$72,DEFAULT,$73,$74,DEFAULT,DEFAULT,$75,$76,$77,$78,DEFAULT,$79,$80) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r4c11 sql.NullBool
			r4c12 sql.NullBool
			r4c13 sql.NullString
			r4c14 ducktype.NullUint64
			r4c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, err = transform(p[4]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15)), p[5:], true
	case 6:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48),($49,$50,$51,DEFAULT,$52,DEFAULT,$53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,DEFAULT,DEFAULT,$59,$60,$61,$62,DEFAULT,$63,$64),($65,$66,$67,DEFAULT,$68,DEFAULT,$69,DEFAULT,$70,$71,$72,DEFAULT,$73,$74,DEFAULT,DEFAULT,$75,$76,$77,$78,DEFAULT,$79,$80),($81,$82,$83,DEFAULT,$84,DEFAULT,$85,DEFAULT,$86,$87,$88,DEFAULT,$89,$90,DEFAULT,DEFAULT,$91,$92,$93,$94,DEFAULT,$95,$96) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r5c11 sql.NullBool
			r5c12 sql.NullBool
			r5c13 sql.NullString
			r5c14 ducktype.NullUint64
			r5c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, err = transform(p[5]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15)), p[6:], true
	case 7:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48),($49,$50,$51,DEFAULT,$52,DEFAULT,$53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,DEFAULT,DEFAULT,$59,$60,$61,$62,DEFAULT,$63,$64),($65,$66,$67,DEFAULT,$68,DEFAULT,$69,DEFAULT,$70,$71,$72,DEFAULT,$73,$74,DEFAULT,DEFAULT,$75,$76,$77,$78,DEFAULT,$79,$80),($81,$82,$83,DEFAULT,$84,DEFAULT,$85,DEFAULT,$86,$87,$88,DEFAULT,$89,$90,DEFAULT,DEFAULT,$91,$92,$93,$94,DEFAULT,$95,$96),($97,$98,$99,DEFAULT,$100,DEFAULT,$101,DEFAULT,$102,$103,$104,DEFAULT,$105,$106,DEFAULT,DEFAULT,$107,$108,$109,$110,DEFAULT,$111,$112) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r6c11 sql.NullBool
			r6c12 sql.NullBool
			r6c13 sql.NullString
			r6c14 ducktype.NullUint64
			r6c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, err = transform(p[6]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15)), p[7:], true
	case 8:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48),($49,$50,$51,DEFAULT,$52,DEFAULT,$53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,DEFAULT,DEFAULT,$59,$60,$61,$62,DEFAULT,$63,$64),($65,$66,$67,DEFAULT,$68,DEFAULT,$69,DEFAULT,$70,$71,$72,DEFAULT,$73,$74,DEFAULT,DEFAULT,$75,$76,$77,$78,DEFAULT,$79,$80),($81,$82,$83,DEFAULT,$84,DEFAULT,$85,DEFAULT,$86,$87,$88,DEFAULT,$89,$90,DEFAULT,DEFAULT,$91,$92,$93,$94,DEFAULT,$95,$96),($97,$98,$99,DEFAULT,$100,DEFAULT,$101,DEFAULT,$102,$103,$104,DEFAULT,$105,$106,DEFAULT,DEFAULT,$107,$108,$109,$110,DEFAULT,$111,$112),($113,$114,$115,DEFAULT,$116,DEFAULT,$117,DEFAULT,$118,$119,$120,DEFAULT,$121,$122,DEFAULT,DEFAULT,$123,$124,$125,$126,DEFAULT,$127,$128) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r7c11 sql.NullBool
			r7c12 sql.NullBool
			r7c13 sql.NullString
			r7c14 ducktype.NullUint64
			r7c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15, err = transform(p[7]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15)), p[8:], true
	case 9:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48),($49,$50,$51,DEFAULT,$52,DEFAULT,$53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,DEFAULT,DEFAULT,$59,$60,$61,$62,DEFAULT,$63,$64),($65,$66,$67,DEFAULT,$68,DEFAULT,$69,DEFAULT,$70,$71,$72,DEFAULT,$73,$74,DEFAULT,DEFAULT,$75,$76,$77,$78,DEFAULT,$79,$80),($81,$82,$83,DEFAULT,$84,DEFAULT,$85,DEFAULT,$86,$87,$88,DEFAULT,$89,$90,DEFAULT,DEFAULT,$91,$92,$93,$94,DEFAULT,$95,$96),($97,$98,$99,DEFAULT,$100,DEFAULT,$101,DEFAULT,$102,$103,$104,DEFAULT,$105,$106,DEFAULT,DEFAULT,$107,$108,$109,$110,DEFAULT,$111,$112),($113,$114,$115,DEFAULT,$116,DEFAULT,$117,DEFAULT,$118,$119,$120,DEFAULT,$121,$122,DEFAULT,DEFAULT,$123,$124,$125,$126,DEFAULT,$127,$128),($129,$130,$131,DEFAULT,$132,DEFAULT,$133,DEFAULT,$134,$135,$136,DEFAULT,$137,$138,DEFAULT,DEFAULT,$139,$140,$141,$142,DEFAULT,$143,$144) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r8c11 sql.NullBool
			r8c12 sql.NullBool
			r8c13 sql.NullString
			r8c14 ducktype.NullUint64
			r8c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, r8c13, r8c14, r8c15, err = transform(p[8]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, r8c13, r8c14, r8c15)), p[9:], true
	default:
		const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,$16),($17,$18,$19,DEFAULT,$20,DEFAULT,$21,DEFAULT,$22,$23,$24,DEFAULT,$25,$26,DEFAULT,DEFAULT,$27,$28,$29,$30,DEFAULT,$31,$32),($33,$34,$35,DEFAULT,$36,DEFAULT,$37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,DEFAULT,DEFAULT,$43,$44,$45,$46,DEFAULT,$47,$48),($49,$50,$51,DEFAULT,$52,DEFAULT,$53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,DEFAULT,DEFAULT,$59,$60,$61,$62,DEFAULT,$63,$64),($65,$66,$67,DEFAULT,$68,DEFAULT,$69,DEFAULT,$70,$71,$72,DEFAULT,$73,$74,DEFAULT,DEFAULT,$75,$76,$77,$78,DEFAULT,$79,$80),($81,$82,$83,DEFAULT,$84,DEFAULT,$85,DEFAULT,$86,$87,$88,DEFAULT,$89,$90,DEFAULT,DEFAULT,$91,$92,$93,$94,DEFAULT,$95,$96),($97,$98,$99,DEFAULT,$100,DEFAULT,$101,DEFAULT,$102,$103,$104,DEFAULT,$105,$106,DEFAULT,DEFAULT,$107,$108,$109,$110,DEFAULT,$111,$112),($113,$114,$115,DEFAULT,$116,DEFAULT,$117,DEFAULT,$118,$119,$120,DEFAULT,$121,$122,DEFAULT,DEFAULT,$123,$124,$125,$126,DEFAULT,$127,$128),($129,$130,$131,DEFAULT,$132,DEFAULT,$133,DEFAULT,$134,$135,$136,DEFAULT,$137,$138,DEFAULT,DEFAULT,$139,$140,$141,$142,DEFAULT,$143,$144),($145,$146,$147,DEFAULT,$148,DEFAULT,$149,DEFAULT,$150,$151,$152,DEFAULT,$153,$154,DEFAULT,DEFAULT,$155,$156,$157,$158,DEFAULT,$159,$160) RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
		var (
			r0c0  sql.NullBool
			r0c1  sql.NullString
			r0c2  ducktype.NullUint64
			...
			r9c11 sql.NullBool
			r9c12 sql.NullBool
			r9c13 sql.NullString
			r9c14 ducktype.NullUint64
			r9c15 sql.NullTime
			err   error
		)
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, err = transform(p[0]); err != nil {
		...
		if r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8, r9c9, r9c10, r9c11, r9c12, r9c13, r9c14, r9c15, err = transform(p[9]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r0c13, r0c14, r0c15, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r1c13, r1c14, r1c15, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r2c13, r2c14, r2c15, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r3c13, r3c14, r3c15, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r4c13, r4c14, r4c15, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r5c13, r5c14, r5c15, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r6c13, r6c14, r6c15, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r7c13, r7c14, r7c15, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, r8c13, r8c14, r8c15, r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8, r9c9, r9c10, r9c11, r9c12, r9c13, r9c14, r9c15)), []Metadata(nil), false
	}
}

// MetadataInsertWithDefaultsStaticColumns generated by genieql
const MetadataInsertWithDefaultsStaticColumns = `$1,$2,$3,DEFAULT,$4,$5,$6,DEFAULT,$7,DEFAULT,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,DEFAULT`
...
func MetadataInsertWithDefaultsExplode(a *Metadata) ([]interface{}, error) {
	var (
		...
		c4  ducktype.NullUint64 // downloaded
		c5  sql.NullString      // encryption_seed
		c6  sql.NullString      // id
		c7  []byte              // infohash
		c8  sql.NullString      // known_media_id
		c9  sql.NullString      // mimetype
		c10 sql.NullInt32       // peers
		c11 sql.NullBool        // private
		c12 sql.NullBool        // seeding
		c13 sql.NullString      // tracker
		c14 ducktype.NullUint64 // uploaded
	)
	...
	c8.Valid = true
	c8.String = a.KnownMediaID

	c9.Valid = true
	c9.String = a.Mimetype

	c10.Valid = true
	c10.Int32 = int32(a.Peers)
...
func MetadataInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Metadata) MetadataScannerStaticRow {
	const query = `INSERT INTO "torrents_metadata" ("archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at") VALUES ($1,$2,$3,DEFAULT,$4,$5,$6,DEFAULT,$7,DEFAULT,$8,DEFAULT,$9,$10,DEFAULT,DEFAULT,$11,$12,$13,$14,DEFAULT,$15,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, tracker = EXCLUDED.tracker RETURNING "archivable","auto_description","bytes","created_at","description","downloaded","encryption_seed","hidden_at","id","imported_at","infohash","initiated_at","known_media_id","mimetype","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded","verify_at"`
	var (
		c0  sql.NullBool        // archivable
		c1  sql.NullString      // auto_description
		c2  ducktype.NullUint64 // bytes
