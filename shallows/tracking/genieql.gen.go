...
const MetadataScannerStaticColumns = `torrents_metadata."auto_description",torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."known_media_id",torrents_metadata."next_announce_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."private",torrents_metadata."seeding",torrents_metadata."tracker",torrents_metadata."updated_at",torrents_metadata."uploaded"`
...
const RSSScannerStaticColumns = `torrents_feed_rss."autoarchive",torrents_feed_rss."autodownload",torrents_feed_rss."contributing",torrents_feed_rss."created_at",torrents_feed_rss."description",torrents_feed_rss."disabled_at",torrents_feed_rss."id",torrents_feed_rss."last_built_at",torrents_feed_rss."next_check",torrents_feed_rss."updated_at",torrents_feed_rss."url"`
...
const MetadataInsertWithDefaultsStaticColumns = `$1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11`

// MetadataInsertWithDefaultsExplode generated by genieql
func MetadataInsertWithDefaultsExplode(a *Metadata) ([]interface{}, error) {
	var (
		c0  sql.NullString // auto_description
		c1  sql.NullInt64  // bytes
		c2  sql.NullString // description
		c3  sql.NullString // id
		c4  []byte         // infohash
		c5  sql.NullString // known_media_id
		c6  sql.NullInt32  // peers
		c7  sql.NullBool   // private
		c8  sql.NullBool   // seeding
		c9  sql.NullString // tracker
		c10 sql.NullInt64  // uploaded
	)

	c0.Valid = true
	c0.String = a.AutoDescription
	...
	c5.Valid = true
	c5.String = a.KnownMediaID

	c6.Valid = true
	c6.Int32 = int32(a.Peers)
...
func MetadataInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Metadata) MetadataScannerStaticRow {
	const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, tracker = EXCLUDED.tracker RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
	var (
		c0  sql.NullString // auto_description
		c1  sql.NullInt64  // bytes
		c2  sql.NullString // description
	...
	c9.String = a.Tracker
	c10.Valid = true
	c10.Int64 = int64(a.Uploaded) // uploaded
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10))
}
...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullString, c1 sql.NullInt64, c2 sql.NullString, c3 sql.NullString, c4 []byte, c5 sql.NullString, c6 sql.NullInt32, c7 sql.NullBool, c8 sql.NullBool, c9 sql.NullString, c10 sql.NullInt64, err error) {
		c0.Valid = true
		c0.String = p.AutoDescription
		c1.Valid = true
		c1.Int64 = int64(p.Bytes)
		c2.Valid = true
		c2.String = p.Description
		c3.Valid = true
		c3.String = p.ID
		c4 = p.Infohash
		c5.Valid = true
		c5.String = p.KnownMediaID
		c6.Valid = true
		c6.Int32 = int32(p.Peers)
		c7.Valid = true
		c7.Bool = p.Private
		c8.Valid = true
		c8.Bool = p.Seeding
	...
	case 1:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 2:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 3:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 4:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33),($34,$35,DEFAULT,$36,DEFAULT,DEFAULT,$37,$38,DEFAULT,$39,DEFAULT,DEFAULT,$40,$41,$42,$43,DEFAULT,$44) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 5:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33),($34,$35,DEFAULT,$36,DEFAULT,DEFAULT,$37,$38,DEFAULT,$39,DEFAULT,DEFAULT,$40,$41,$42,$43,DEFAULT,$44),($45,$46,DEFAULT,$47,DEFAULT,DEFAULT,$48,$49,DEFAULT,$50,DEFAULT,DEFAULT,$51,$52,$53,$54,DEFAULT,$55) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 6:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33),($34,$35,DEFAULT,$36,DEFAULT,DEFAULT,$37,$38,DEFAULT,$39,DEFAULT,DEFAULT,$40,$41,$42,$43,DEFAULT,$44),($45,$46,DEFAULT,$47,DEFAULT,DEFAULT,$48,$49,DEFAULT,$50,DEFAULT,DEFAULT,$51,$52,$53,$54,DEFAULT,$55),($56,$57,DEFAULT,$58,DEFAULT,DEFAULT,$59,$60,DEFAULT,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,DEFAULT,$66) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 7:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33),($34,$35,DEFAULT,$36,DEFAULT,DEFAULT,$37,$38,DEFAULT,$39,DEFAULT,DEFAULT,$40,$41,$42,$43,DEFAULT,$44),($45,$46,DEFAULT,$47,DEFAULT,DEFAULT,$48,$49,DEFAULT,$50,DEFAULT,DEFAULT,$51,$52,$53,$54,DEFAULT,$55),($56,$57,DEFAULT,$58,DEFAULT,DEFAULT,$59,$60,DEFAULT,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,DEFAULT,$66),($67,$68,DEFAULT,$69,DEFAULT,DEFAULT,$70,$71,DEFAULT,$72,DEFAULT,DEFAULT,$73,$74,$75,$76,DEFAULT,$77) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 8:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33),($34,$35,DEFAULT,$36,DEFAULT,DEFAULT,$37,$38,DEFAULT,$39,DEFAULT,DEFAULT,$40,$41,$42,$43,DEFAULT,$44),($45,$46,DEFAULT,$47,DEFAULT,DEFAULT,$48,$49,DEFAULT,$50,DEFAULT,DEFAULT,$51,$52,$53,$54,DEFAULT,$55),($56,$57,DEFAULT,$58,DEFAULT,DEFAULT,$59,$60,DEFAULT,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,DEFAULT,$66),($67,$68,DEFAULT,$69,DEFAULT,DEFAULT,$70,$71,DEFAULT,$72,DEFAULT,DEFAULT,$73,$74,$75,$76,DEFAULT,$77),($78,$79,DEFAULT,$80,DEFAULT,DEFAULT,$81,$82,DEFAULT,$83,DEFAULT,DEFAULT,$84,$85,$86,$87,DEFAULT,$88) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	case 9:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33),($34,$35,DEFAULT,$36,DEFAULT,DEFAULT,$37,$38,DEFAULT,$39,DEFAULT,DEFAULT,$40,$41,$42,$43,DEFAULT,$44),($45,$46,DEFAULT,$47,DEFAULT,DEFAULT,$48,$49,DEFAULT,$50,DEFAULT,DEFAULT,$51,$52,$53,$54,DEFAULT,$55),($56,$57,DEFAULT,$58,DEFAULT,DEFAULT,$59,$60,DEFAULT,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,DEFAULT,$66),($67,$68,DEFAULT,$69,DEFAULT,DEFAULT,$70,$71,DEFAULT,$72,DEFAULT,DEFAULT,$73,$74,$75,$76,DEFAULT,$77),($78,$79,DEFAULT,$80,DEFAULT,DEFAULT,$81,$82,DEFAULT,$83,DEFAULT,DEFAULT,$84,$85,$86,$87,DEFAULT,$88),($89,$90,DEFAULT,$91,DEFAULT,DEFAULT,$92,$93,DEFAULT,$94,DEFAULT,DEFAULT,$95,$96,$97,$98,DEFAULT,$99) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
	...
	default:
		const query = `INSERT INTO "torrents_metadata" ("auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,$2,DEFAULT,$3,DEFAULT,DEFAULT,$4,$5,DEFAULT,$6,DEFAULT,DEFAULT,$7,$8,$9,$10,DEFAULT,$11),($12,$13,DEFAULT,$14,DEFAULT,DEFAULT,$15,$16,DEFAULT,$17,DEFAULT,DEFAULT,$18,$19,$20,$21,DEFAULT,$22),($23,$24,DEFAULT,$25,DEFAULT,DEFAULT,$26,$27,DEFAULT,$28,DEFAULT,DEFAULT,$29,$30,$31,$32,DEFAULT,$33),($34,$35,DEFAULT,$36,DEFAULT,DEFAULT,$37,$38,DEFAULT,$39,DEFAULT,DEFAULT,$40,$41,$42,$43,DEFAULT,$44),($45,$46,DEFAULT,$47,DEFAULT,DEFAULT,$48,$49,DEFAULT,$50,DEFAULT,DEFAULT,$51,$52,$53,$54,DEFAULT,$55),($56,$57,DEFAULT,$58,DEFAULT,DEFAULT,$59,$60,DEFAULT,$61,DEFAULT,DEFAULT,$62,$63,$64,$65,DEFAULT,$66),($67,$68,DEFAULT,$69,DEFAULT,DEFAULT,$70,$71,DEFAULT,$72,DEFAULT,DEFAULT,$73,$74,$75,$76,DEFAULT,$77),($78,$79,DEFAULT,$80,DEFAULT,DEFAULT,$81,$82,DEFAULT,$83,DEFAULT,DEFAULT,$84,$85,$86,$87,DEFAULT,$88),($89,$90,DEFAULT,$91,DEFAULT,DEFAULT,$92,$93,DEFAULT,$94,DEFAULT,DEFAULT,$95,$96,$97,$98,DEFAULT,$99),($100,$101,DEFAULT,$102,DEFAULT,DEFAULT,$103,$104,DEFAULT,$105,DEFAULT,DEFAULT,$106,$107,$108,$109,DEFAULT,$110) RETURNING "auto_description","bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","known_media_id","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullString
			r0c1  sql.NullInt64
			r0c2  sql.NullString
...
func MetadataFindByID(ctx context.Context, q sqlx.Queryer, id string) MetadataScannerStaticRow {
	const query = `SELECT torrents_metadata."auto_description",torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."known_media_id",torrents_metadata."next_announce_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."private",torrents_metadata."seeding",torrents_metadata."tracker",torrents_metadata."updated_at",torrents_metadata."uploaded" FROM torrents_metadata WHERE "id" = $1`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0))
...
func MetadataCompleteByID(ctx context.Context, q sqlx.Queryer, id string, peers uint16, downloaded uint64, uploaded uint64) MetadataScannerStaticRow {
	const query = `UPDATE torrents_metadata SET updated_at = NOW(), downloaded = $3, uploaded = $4, peers = $2, seeding = (bytes == $3) WHERE "id" = $1 RETURNING torrents_metadata."auto_description",torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."known_media_id",torrents_metadata."next_announce_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."private",torrents_metadata."seeding",torrents_metadata."tracker",torrents_metadata."updated_at",torrents_metadata."uploaded"`
	var (
		c0 sql.NullString   // id
		c1 sql.Null[uint16] // peers
	)
...
const RSSInsertWithDefaultsStaticColumns = `$1,$2,$3,DEFAULT,$4,DEFAULT,$5,$6,DEFAULT,DEFAULT,$7`
...
func RSSInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autoarchive","autodownload","contributing","created_at","description","disabled_at","id","last_built_at","next_check","updated_at","url") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,$6,DEFAULT,DEFAULT,$7) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, autodownload = EXCLUDED.autodownload, autoarchive = EXCLUDED.autoarchive, url = EXCLUDED.url, description = EXCLUDED.description RETURNING "autoarchive","autodownload","contributing","created_at","description","disabled_at","id","last_built_at","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autoarchive
		c1 sql.NullBool   // autodownload
		c2 sql.NullBool   // contributing
...
const RSSInsertDefaultFeedStaticColumns = `$1,$2,$3,DEFAULT,$4,DEFAULT,$5,$6,DEFAULT,DEFAULT,$7`
...
func RSSInsertDefaultFeed(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autoarchive","autodownload","contributing","created_at","description","disabled_at","id","last_built_at","next_check","updated_at","url") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,$6,DEFAULT,DEFAULT,$7) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "autoarchive","autodownload","contributing","created_at","description","disabled_at","id","last_built_at","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autoarchive
		c1 sql.NullBool   // autodownload
		c2 sql.NullBool   // contributing
...
const RSSCooldownStaticColumns = `$1,$2,$3,DEFAULT,$4,$5,$6,$7,$8,DEFAULT,$9`
...
func RSSCooldownExplode(a *RSS) ([]interface{}, error) {
	var (
		...
		c7 sql.NullTime   // next_check
		c8 sql.NullString // url
	)
...
func RSSCooldown(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autoarchive","autodownload","contributing","created_at","description","disabled_at","id","last_built_at","next_check","updated_at","url") VALUES ($1,$2,$3,DEFAULT,$4,$5,$6,$7,$8,DEFAULT,$9) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, next_check = NOW() + to_minutes({ttl}) RETURNING "autoarchive","autodownload","contributing","created_at","description","disabled_at","id","last_built_at","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autoarchive
		c1 sql.NullBool   // autodownload
		c2 sql.NullBool   // contributing
	...
	c8.Valid = true
	c8.String = a.URL // url
	return NewRSSScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5, c6, c7, c8))
}
...
func RSSCooldownByID(ctx context.Context, q sqlx.Queryer, id string, ttl int, lastbuild time.Time) RSSScannerStaticRow {
	const query = `UPDATE torrents_feed_rss SET updated_at = DEFAULT, next_check = NOW() + to_minutes($2), last_built_at = $3 WHERE "id" = $1 RETURNING torrents_feed_rss."autoarchive",torrents_feed_rss."autodownload",torrents_feed_rss."contributing",torrents_feed_rss."created_at",torrents_feed_rss."description",torrents_feed_rss."disabled_at",torrents_feed_rss."id",torrents_feed_rss."last_built_at",torrents_feed_rss."next_check",torrents_feed_rss."updated_at",torrents_feed_rss."url"`
	var (
		c0 sql.NullString // id
...
func RSSDeleteByID(ctx context.Context, q sqlx.Queryer, id string) RSSScannerStaticRow {
	const query = `DELETE FROM torrents_feed_rss WHERE "id" = $1 RETURNING torrents_feed_rss."autoarchive",torrents_feed_rss."autodownload",torrents_feed_rss."contributing",torrents_feed_rss."created_at",torrents_feed_rss."description",torrents_feed_rss."disabled_at",torrents_feed_rss."id",torrents_feed_rss."last_built_at",torrents_feed_rss."next_check",torrents_feed_rss."updated_at",torrents_feed_rss."url"`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
