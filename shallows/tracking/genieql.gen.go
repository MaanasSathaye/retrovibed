...
const MetadataScannerStaticColumns = `torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."next_announce_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."private",torrents_metadata."seeding",torrents_metadata."tracker",torrents_metadata."updated_at",torrents_metadata."uploaded"`
...
const MetadataInsertWithDefaultsStaticColumns = `$1,DEFAULT,$2,DEFAULT,DEFAULT,$3,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,$9,DEFAULT,$10`
...
func MetadataInsertWithDefaultsExplode(a *Metadata) ([]interface{}, error) {
	var (
		...
		c3 []byte         // infohash
		c4 sql.NullTime   // next_announce_at
		c5 sql.NullInt32  // peers
		c6 sql.NullBool   // private
		c7 sql.NullBool   // seeding
		c8 sql.NullString // tracker
		c9 sql.NullInt64  // uploaded
	)
	...
	c4.Valid = true
	c4.Time = a.NextAnnounceAt

	c5.Valid = true
	c5.Int32 = int32(a.Peers)
...
func MetadataInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Metadata) MetadataScannerStaticRow {
	const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,DEFAULT,DEFAULT,$3,$4,DEFAULT,$5,DEFAULT,$6,$7,$8,$9,DEFAULT,$10) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, tracker = EXCLUDED.tracker RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
	var (
		c0 sql.NullInt64  // bytes
		c1 sql.NullString // description
		c2 sql.NullString // id
	...
	c8.String = a.Tracker
	c9.Valid = true
	c9.Int64 = int64(a.Uploaded) // uploaded
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9))
}
...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullInt64, c1 sql.NullString, c2 sql.NullInt64, c3 sql.NullTime, c4 []byte, c5 sql.NullTime, c6 sql.NullTime, c7 sql.NullTime, c8 sql.NullInt32, c9 sql.NullBool, c10 sql.NullBool, c11 sql.NullString, c12 sql.NullInt64, err error) {
		c0.Valid = true
	...
	case 1:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, err = transform(p[0]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12)), p[1:], true
	case 2:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, err = transform(p[1]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12)), p[2:], true
	case 3:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, err = transform(p[2]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12)), p[3:], true
	case 4:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39),($40,DEFAULT,$41,$42,$43,DEFAULT,$44,$45,$46,$47,$48,$49,$50,$51,DEFAULT,$52) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, err = transform(p[3]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12)), p[4:], true
	case 5:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39),($40,DEFAULT,$41,$42,$43,DEFAULT,$44,$45,$46,$47,$48,$49,$50,$51,DEFAULT,$52),($53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,$59,$60,$61,$62,$63,$64,DEFAULT,$65) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, err = transform(p[4]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12)), p[5:], true
	case 6:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39),($40,DEFAULT,$41,$42,$43,DEFAULT,$44,$45,$46,$47,$48,$49,$50,$51,DEFAULT,$52),($53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,$59,$60,$61,$62,$63,$64,DEFAULT,$65),($66,DEFAULT,$67,$68,$69,DEFAULT,$70,$71,$72,$73,$74,$75,$76,$77,DEFAULT,$78) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, err = transform(p[5]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12)), p[6:], true
	case 7:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39),($40,DEFAULT,$41,$42,$43,DEFAULT,$44,$45,$46,$47,$48,$49,$50,$51,DEFAULT,$52),($53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,$59,$60,$61,$62,$63,$64,DEFAULT,$65),($66,DEFAULT,$67,$68,$69,DEFAULT,$70,$71,$72,$73,$74,$75,$76,$77,DEFAULT,$78),($79,DEFAULT,$80,$81,$82,DEFAULT,$83,$84,$85,$86,$87,$88,$89,$90,DEFAULT,$91) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, err = transform(p[6]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12)), p[7:], true
	case 8:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39),($40,DEFAULT,$41,$42,$43,DEFAULT,$44,$45,$46,$47,$48,$49,$50,$51,DEFAULT,$52),($53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,$59,$60,$61,$62,$63,$64,DEFAULT,$65),($66,DEFAULT,$67,$68,$69,DEFAULT,$70,$71,$72,$73,$74,$75,$76,$77,DEFAULT,$78),($79,DEFAULT,$80,$81,$82,DEFAULT,$83,$84,$85,$86,$87,$88,$89,$90,DEFAULT,$91),($92,DEFAULT,$93,$94,$95,DEFAULT,$96,$97,$98,$99,$100,$101,$102,$103,DEFAULT,$104) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, err = transform(p[7]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12)), p[8:], true
	case 9:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39),($40,DEFAULT,$41,$42,$43,DEFAULT,$44,$45,$46,$47,$48,$49,$50,$51,DEFAULT,$52),($53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,$59,$60,$61,$62,$63,$64,DEFAULT,$65),($66,DEFAULT,$67,$68,$69,DEFAULT,$70,$71,$72,$73,$74,$75,$76,$77,DEFAULT,$78),($79,DEFAULT,$80,$81,$82,DEFAULT,$83,$84,$85,$86,$87,$88,$89,$90,DEFAULT,$91),($92,DEFAULT,$93,$94,$95,DEFAULT,$96,$97,$98,$99,$100,$101,$102,$103,DEFAULT,$104),($105,DEFAULT,$106,$107,$108,DEFAULT,$109,$110,$111,$112,$113,$114,$115,$116,DEFAULT,$117) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, err = transform(p[8]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12)), p[9:], true
	default:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,$10,$11,$12,DEFAULT,$13),($14,DEFAULT,$15,$16,$17,DEFAULT,$18,$19,$20,$21,$22,$23,$24,$25,DEFAULT,$26),($27,DEFAULT,$28,$29,$30,DEFAULT,$31,$32,$33,$34,$35,$36,$37,$38,DEFAULT,$39),($40,DEFAULT,$41,$42,$43,DEFAULT,$44,$45,$46,$47,$48,$49,$50,$51,DEFAULT,$52),($53,DEFAULT,$54,$55,$56,DEFAULT,$57,$58,$59,$60,$61,$62,$63,$64,DEFAULT,$65),($66,DEFAULT,$67,$68,$69,DEFAULT,$70,$71,$72,$73,$74,$75,$76,$77,DEFAULT,$78),($79,DEFAULT,$80,$81,$82,DEFAULT,$83,$84,$85,$86,$87,$88,$89,$90,DEFAULT,$91),($92,DEFAULT,$93,$94,$95,DEFAULT,$96,$97,$98,$99,$100,$101,$102,$103,DEFAULT,$104),($105,DEFAULT,$106,$107,$108,DEFAULT,$109,$110,$111,$112,$113,$114,$115,$116,DEFAULT,$117),($118,DEFAULT,$119,$120,$121,DEFAULT,$122,$123,$124,$125,$126,$127,$128,$129,DEFAULT,$130) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","next_announce_at","paused_at","peers","private","seeding","tracker","updated_at","uploaded"`
		var (
			r0c0  sql.NullInt64
			r0c1  sql.NullString
			r0c2  sql.NullInt64
		...
		if r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8, r9c9, r9c10, r9c11, r9c12, err = transform(p[9]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r0c9, r0c10, r0c11, r0c12, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r1c9, r1c10, r1c11, r1c12, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r2c9, r2c10, r2c11, r2c12, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r3c9, r3c10, r3c11, r3c12, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r4c9, r4c10, r4c11, r4c12, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r5c9, r5c10, r5c11, r5c12, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r6c9, r6c10, r6c11, r6c12, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r7c9, r7c10, r7c11, r7c12, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r8c9, r8c10, r8c11, r8c12, r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8, r9c9, r9c10, r9c11, r9c12)), []Metadata(nil), false
	}
}
...
func MetadataFindByID(ctx context.Context, q sqlx.Queryer, id string) MetadataScannerStaticRow {
	const query = `SELECT torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."next_announce_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."private",torrents_metadata."seeding",torrents_metadata."tracker",torrents_metadata."updated_at",torrents_metadata."uploaded" FROM torrents_metadata WHERE "id" = $1`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0))
...
const RSSInsertDefaultFeedStaticColumns = `$1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,DEFAULT,$6`
...
func RSSInsertDefaultFeed(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autoarchive","autodownload","contributing","created_at","description","disabled_at","id","next_check","updated_at","url") VALUES ($1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,DEFAULT,$6) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "autoarchive","autodownload","contributing","created_at","description","disabled_at","id","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autoarchive
		c1 sql.NullBool   // autodownload
		c2 sql.NullBool   // contributing
