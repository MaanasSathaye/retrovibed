...
const MetadataInsertWithDefaultsStaticColumns = `$1,$2,$3,DEFAULT,$4,DEFAULT,$5,DEFAULT,$6,$7,DEFAULT,$8,DEFAULT,DEFAULT,$9,$10,$11,$12,DEFAULT,$13,$14`
...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullBool, c1 sql.NullString, c2 sql.Null[uint64], c3 sql.NullString, c4 sql.NullString, c5 sql.NullString, c6 []byte, c7 sql.NullString, c8 sql.NullInt32, c9 sql.NullBool, c10 sql.NullBool, c11 sql.NullString, c12 sql.Null[uint64], c13 sql.NullTime, err error) {
		c0.Valid = true
