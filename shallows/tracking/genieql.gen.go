...
const MetadataInsertWithDefaultsStaticColumns = `$1,$2,$3,DEFAULT,$4,$5,$6,DEFAULT,$7,$8,DEFAULT,$9,DEFAULT,DEFAULT,$10,$11,$12,$13,DEFAULT,$14,DEFAULT`
...
func MetadataInsertWithDefaultsExplode(a *Metadata) ([]interface{}, error) {
	var (
		...
		c9  sql.NullInt32       // peers
		c10 sql.NullBool        // private
		c11 sql.NullBool        // seeding
		c12 sql.NullString      // tracker
		c13 ducktype.NullUint64 // uploaded
	)
