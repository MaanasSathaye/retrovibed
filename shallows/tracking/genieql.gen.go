...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullString, c1 sql.Null[uint64], c2 sql.NullString, c3 sql.NullString, c4 []byte, c5 sql.NullString, c6 sql.NullInt32, c7 sql.NullBool, c8 sql.NullBool, c9 sql.NullString, c10 sql.Null[uint64], err error) {
		c0.Valid = true
...
func PeerInsertWithDefaultsExplode(a *Peer) ([]interface{}, error) {
	var (
		...
		c1 sql.Null[uint64] // bep51_available
