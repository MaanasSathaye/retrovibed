...
const ProfileInsertWithIDStaticColumns = `DEFAULT,$1,DEFAULT,DEFAULT,DEFAULT,$2,DEFAULT,DEFAULT`
...
func ProfileInsertWithID(ctx context.Context, q sqlx.Queryer, a Profile) ProfileScannerStaticRow {
	const query = `INSERT INTO "meta_profiles" ("created_at","description","disabled_at","disabled_manually_at","disabled_pending_approval_at","id","session_watermark","updated_at") VALUES (DEFAULT,$1,DEFAULT,DEFAULT,DEFAULT,$2,DEFAULT,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "created_at","description","disabled_at","disabled_manually_at","disabled_pending_approval_at","id","session_watermark","updated_at"`
	var (
		c0 sql.NullString // description
		c1 sql.NullString
	)
...
func DaemonTouch(ctx context.Context, q sqlx.Queryer, id string) DaemonScannerStaticRow {
	const query = `UPDATE meta_daemons SET updated_at = NOW() WHERE "id" = $1 RETURNING meta_daemons."created_at",meta_daemons."description",meta_daemons."hostname",meta_daemons."id",meta_daemons."updated_at"`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
...
func DaemonDeleteByID(ctx context.Context, q sqlx.Queryer, id string) DaemonScannerStaticRow {
	const query = `DELETE FROM meta_daemons WHERE "id" = $1 RETURNING meta_daemons."created_at",meta_daemons."description",meta_daemons."hostname",meta_daemons."id",meta_daemons."updated_at"`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
	return NewDaemonScannerStaticRow(q.QueryRowContext(ctx, query, c0))
...
const AuthzInsertWithIDDefaultsStaticColumns = `DEFAULT,$1,$2,$3,$4`

// AuthzInsertWithIDDefaultsExplode generated by genieql
func AuthzInsertWithIDDefaultsExplode(a *Authz) ([]interface{}, error) {
	var (
		c0 sql.NullString // id
		c1 sql.NullString // profile_id
		c2 sql.NullTime   // updated_at
		c3 sql.NullBool   // usermanagement
	)
	...
	c1.Valid = true
	c1.String = a.ProfileID

	c2.Valid = true
	c2.Time = a.UpdatedAt

	c3.Valid = true
	c3.Bool = a.Usermanagement
...
func AuthzInsertWithIDDefaults(ctx context.Context, q sqlx.Queryer, a Authz) AuthzScannerStaticRow {
	const query = `INSERT INTO "authz_meta" ("created_at","id","profile_id","updated_at","usermanagement") VALUES (DEFAULT,$1,$2,$3,$4) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "created_at","id","profile_id","updated_at","usermanagement"`
	var (
		c0 sql.NullString // id
		c1 sql.NullString // profile_id
		c2 sql.NullTime   // updated_at
	...
	c2.Time = a.UpdatedAt
	c3.Valid = true
	c3.Bool = a.Usermanagement // usermanagement
	return NewAuthzScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3))
}
